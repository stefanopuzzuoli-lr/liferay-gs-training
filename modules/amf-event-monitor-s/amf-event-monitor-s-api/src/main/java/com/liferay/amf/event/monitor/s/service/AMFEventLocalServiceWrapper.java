 ...
 */
@ProviderType
public class AMFEventLocalServiceWrapper
	implements AMFEventLocalService, ServiceWrapper<AMFEventLocalService> {
	...
	public com.liferay.amf.event.monitor.s.model.AMFEvent addAMFEvent(
		...
		return _amfEventLocalService.addAMFEvent(
	 ...
	 */
	@Override
	public com.liferay.amf.event.monitor.s.model.AMFEvent createAMFEvent(
		long auditEventId) {

		return _amfEventLocalService.createAMFEvent(auditEventId);
	}
	 ...
	 */
	@Override
	public com.liferay.amf.event.monitor.s.model.AMFEvent deleteAMFEvent(
		com.liferay.amf.event.monitor.s.model.AMFEvent amfEvent) {
	...
	public com.liferay.amf.event.monitor.s.model.AMFEvent deleteAMFEvent(
		...
		return _amfEventLocalService.deleteAMFEvent(auditEventId);
	}
	...
	public long dynamicQueryCount(
		...
		return _amfEventLocalService.dynamicQueryCount(
			dynamicQuery, projection);
	}

	@Override
	public com.liferay.amf.event.monitor.s.model.AMFEvent fetchAMFEvent(
		long auditEventId) {

		return _amfEventLocalService.fetchAMFEvent(auditEventId);
	}
	...
	public com.liferay.amf.event.monitor.s.model.AMFEvent getAMFEvent(
		...
		return _amfEventLocalService.getAMFEvent(auditEventId);
	}
	...
	public java.util.List<com.liferay.amf.event.monitor.s.model.AMFEvent>
		...
		return _amfEventLocalService.getAMFEventByEventType(eventType);
	}
	...
	public java.util.List<com.liferay.amf.event.monitor.s.model.AMFEvent>
		...
		return _amfEventLocalService.getAMFEventByUserId(userId);
	}
	...
	public java.util.List<com.liferay.amf.event.monitor.s.model.AMFEvent>
		...
		return _amfEventLocalService.getAMFEventByUserIdAndEventType(
			userId, eventType);
	}
	 ...
	 */
	@Override
	public com.liferay.amf.event.monitor.s.model.AMFEvent updateAMFEvent(
		com.liferay.amf.event.monitor.s.model.AMFEvent amfEvent) {
