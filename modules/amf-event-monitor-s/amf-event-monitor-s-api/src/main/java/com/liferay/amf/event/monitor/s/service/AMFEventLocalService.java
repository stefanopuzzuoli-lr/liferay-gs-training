...
/**
 * Provides the local service interface for AMFEvent. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AMFEventLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AMFEventLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AMFEventLocalServiceUtil} to access the amf event local service. Add custom service methods to <code>com.liferay.amf.event.monitor.s.service.impl.AMFEventLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public AMFEvent addAMFEvent(AMFEvent amfEvent);
	...
	public AMFEvent createAMFEvent(long auditEventId);
	...
	public AMFEvent deleteAMFEvent(AMFEvent amfEvent);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AMFEvent deleteAMFEvent(long auditEventId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AMFEvent fetchAMFEvent(long auditEventId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AMFEvent getAMFEvent(long auditEventId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AMFEvent> getAMFEvents(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AMFEvent updateAMFEvent(AMFEvent amfEvent);
