...
public class AMFUserServiceHttp {
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				AMFUserServiceUtil.class, "getAMFUserByZip",
				_getAMFUserByZipParameterTypes0);
			...
			return (java.util.List
				<com.liferay.docs.amf.registration.model.AMFUser>)returnObj;
		}
	...
	private static final Class<?>[] _getAMFUserByZipParameterTypes0 =
