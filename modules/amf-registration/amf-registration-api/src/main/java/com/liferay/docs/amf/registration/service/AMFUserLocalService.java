...
public interface AMFUserLocalService
	...
	public AMFUser addAMFUser(
			...
			Boolean male, Date dob, String homePhone, String mobilePhone,
			String address, String address2, String city, String state,
			String zip, String securityQuestion, String securityAnswer,
			Boolean accepted_tou, String password1, String password2,
	...
	public AMFUser updateAMFUser(
			long userId, String username, String firstName, String lastName,
			String email, Boolean male, Date dob, String homePhone,
			...
			String password2, ServiceContext serviceContext)
